...
const getWithYear = async function (req, res) {
    let y = req.body.year
    let yBooks = await BookModel.find({ year: y })
    res.send({ msg: yBooks })
}
const getWithany = async function (req, res) {
    let Obj = req.body
    let anyBooks = await BookModel.find(Obj)
    res.send({ msg: anyBooks })
}

const getWithPrise = async function (req, res) {
    let allBooks = await BookModel.find({ indianPrice: { $or: ["100NIR", "200NIR", "500NIR"] } })
    res.send({ msg: allBooks })
}


const getWithPages = async function (req, res) {
...
module.exports.getWithPrise = getWithPrise
module.exports.getWithYear = getWithYear
module.exports.getWithPages = getWithPages
module.exports.getWithany = getWithany
